              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <h2 className="text-white text-2xl md:text-xl text-center md:text-left mb-4 md:mb-6">
                    Join thousands connecting with wild, playful women in their
                    area. Enjoy private chats, easy meetups, and zero drama.
                  </h2>
                  <p className="text-white text-center md:text-left mb-4 md:mb-6">
                    Enter your email to check availability and explore wild
