...
export default function Home() {
  ...
  const [partnerApiResponse, setPartnerApiResponse] =
    useState<PartnerApiResponse | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      !email ||
      !["@gmail", "@yahoo", "@outlook", "@hotmail"].some((domain) =>
              ...
              {isLoading ? (
                  ...
                  <div className="space-y-3 text-left mb-6">
                    <div className="flex items-center">
                      ...
                      <span className="text-white">
                        Your email is eligible for a free account.
                      </span>
                    </div>
                    <div className="flex items-center">
                      <svg
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-white">
                        ...
                        {partnerApiResponse?.ip_lookup?.country ?? "your area"}{" "}
                        available.
                      </span>
                    </div>
                  </div>
                ...
                <>
                  ...
                  <h2 className="text-white text-2xl md:text-xl text-center md:text-left mb-4 md:mb-6">
                    Single women in your city are waiting to unleash their
                    naughty side. Our site makes it simple: browse, match, and
                    meet without hassle.
                  </h2>
                  <p className="text-white text-center md:text-left mb-4 md:mb-6">
                    Enter your email to check availability and see who&rsquo;s
                    nearby.
                  </p>
        ...
        <footer className="text-white p-4 md:p-6 text-xs">
          <div className="max-w-4xl mx-auto">
            <p className="mb-4">
              ...
              pornstars, escorts, or scammers allowed only everyday people
              looking to explore their sexuality in a safe, discreet, and
              exciting space. Drop your email above to see if you qualify for
              free membership and get instant access to one of the most trusted
              hookup communities online.
            </p>

            <p className="mb-4">
              © 2025 ItsJustSex.org, All rights reserved. Disclaimer: This
              website contains adult material. All members and persons appearing
              on this site have contractually represented to us that they are 18
              years of age or older. 18 U.S.C. 2257 Record Keeping Requirements
